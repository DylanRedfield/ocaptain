...
exports.getVariationsFromEntity = (ed, entities, optional, cache) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.datasetFromAST = (initialAst, writterFn, importHandler, currPath) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const intentKey of intentKeys) {
        ...
        if (entityArgs) {
            ...
            if (intentMax > maxIntentExamples) {
                logger.warn(`Can't generate ${intentMax} examples for intent "${intentKey}". ` +
